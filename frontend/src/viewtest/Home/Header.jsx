  ...
  return (
    <div className='header' id='header'>
      ...
      <ul className='header__page'>
        {isLoggedIn ? (
            <Link to="/about" className='header__page-item login__page'>Về Xe Tốt
            </Link>
        ) : (
          <Link to="/about" className='logout-item-page'>Về Xe Tốt
          </Link>
        )}
        {isLoggedIn ? (
          ...
          <div className='header__page-item-login-overlay'>
            {isLoggedIn ? (
              ...
              <div className='navbar__notuser'>
                ...
                <Link to="/about" className='navbar__notuser-register about__mobile'>
                  <h3 className='navbar__notuser-register-text'>
                    Về Xe Tốt
                  </h3>
                </Link>
